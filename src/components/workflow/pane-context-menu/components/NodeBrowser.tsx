...
export const NodeBrowser: FC<Props> = memo(
  ({ searchValue, nodeOptions, nodeTypes, limit = 10, onSearchChange, onNodeClick, onNodeDragStart }) => {
...
NodeBrowser.displayName = 'NodeBrowser';
